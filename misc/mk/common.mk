...
CXXFLAGS	:= $(CFLAGS) $(EXL_CXXFLAGS) -fno-rtti -fno-exceptions -fno-asynchronous-unwind-tables -fno-unwind-tables -std=gnu++20 -DVERSION_$(VERSION) $(DEBUG_FLAGS)
...
FBSFILES	:=	$(foreach dir,$(SOURCES),$(notdir $(wildcard $(dir)/*.fbs)))
...
export HFILES_FBS	:=	$(addsuffix .h,$(subst .fbs,_generated,$(FBSFILES)))
...
export APP_JSON := $(TOPDIR)/$(VERSION)_config.json
...
$(OFILES_SRC)	:	$(HFILES_BIN) $(HFILES_FBS)
